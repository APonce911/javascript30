...
console.log('Inventors full name');
...
const births = inventors.map( inventor => inventor['year']).reduce(reducer)
const deaths = inventors.map( inventor => inventor['passed']).reduce(reducer)
...
inventors.map( inventor => inventor['years_lived'] = inventor['passed']- inventor['year'])
inventors.sort( (a, b) => a['years_lived'] - b['years_lived']);
console.log(inventors) ;
